  <h1 align="center"> Employee Tracker Command-line App <img align="center" src="https://img.shields.io/badge/license-GPL 2.0-blue"> </h1>

## Description

You can see the project repository [here](https://github.com/mihaelavalac/employee-tracker). <br>
...
Follow the following instructions to install this project: <br> 1. Download Nodejs to your computer. <br> 2. Clone the project repo to your computer `git clone git@github.com:mihaelavalac/employee-tracker.git` <br> 3. Navigate to the root of the project through your text editor. <br> 4. Open terminal and run the following command `npm init` then, `npm install inquirer` , `npm install mysql2`, `npm install console.table` <br> 5. Run the `node index` to start the app. <br> 6. Select the desired action from the command line choices and answer the questions as required. <br> 
